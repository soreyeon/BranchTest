...
<body>
	<table>
		...
		<tr>
			...
			<td style="height:30px; width:100px; text-align:center">메뉴순서</td>
			<td style="height:30px; width:100px; text-align:center">수정하기</td>
			<td style="height:30px; width:100px; text-align:center">삭제하기</td>
		</tr>
		<c:forEach var="menu" items="${ menuList }">
		<tr>
			<td style="height:30px; width:100px; text-align:center">${ menu.menu_id }</td>
			<td style="height:30px; width:100px; text-align:center">${ menu.menu_name }</td>
